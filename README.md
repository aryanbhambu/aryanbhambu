...
- RVFL and deep RVFL models  
- Randomized Hopfield networks  
- Reservoir computing  
- Ensemble randomized learning  
- Multiple output-layer architectures  
...
### 🤖 Deep Learning and DRL

- Deep forecasting models  
- Reinforcement learning for trading  
- Portfolio optimization  
- Bayesian optimization  
- Meta-learning for policy ensembles  
...
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=24&duration=2600&pause=900&color=38BDF8&center=true&vCenter=true&width=950&lines=Learning+Frameworks+for+Time+Series+Analysis;Financial+Decision-Making+with+Backpropagation+and+Randomized+Neural+Networks;Volatility+Forecasting+%E2%80%A2+Risk+Assessment+%E2%80%A2+Portfolio+Optimization;Open+to+Research+Collaborations+and+Opportunities" alt="Research Focus Typing SVG" />
...
- Reviewer for journals in machine learning, neural networks, soft computing, and AI applications
- Teaching support in time series analysis, linear algebra, probability, Monte Carlo simulation, financial engineering, and statistical analysis
- Research experience in AGI-oriented evaluation, technical analysis, and algorithmic validation
- Experience with bootstrap, deep ensembles, uncertainty estimation, and real-time financial forecasting
